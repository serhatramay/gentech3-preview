...
def build_index():
    ...
    body = """
<!-- Hero Section -->
<section class="hero-serene" style="padding-top: 130px; padding-bottom: 4rem;">
    <div class="container">
        <div class="hero-content" style="max-width: 820px; margin: 0 auto 3rem auto; text-align: center;">
            <div class="calm-tag">✦ GLOBAL CAPITAL • PAYMENT TECHNOLOGIES • DIGITAL INFRASTRUCTURE</div>
            <h1 class="serif-title gradient-text" style="margin-bottom: 1.25rem; font-size: clamp(2.4rem, 5.5vw, 4.2rem);">
                Engineering Sovereign Payment Technologies &amp; Global Digital Infrastructure
            </h1>
            ...
            <!-- Co-presence Ticker -->
            <div style="margin-top: 2rem; display: flex; justify-content: center; gap: 1.5rem; flex-wrap: wrap; font-size: 0.85rem; color: var(--text-dim); font-weight: 600;">
        ...
        <!-- 3D WebGL Studio & Interactive Artifact Section -->
        <div class="canvas3d-container" style="margin-top: 2rem; background: radial-gradient(circle at 50% 50%, rgba(255,255,255,0.9) 0%, rgba(243,228,214,0.6) 100%); border-radius: var(--radius-lg); border: 1px solid var(--border-light); padding: 2.5rem; box-shadow: var(--shadow-card);">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
                <div>
                    <span class="calm-tag" style="margin-bottom: 0.3rem;">3D HARDWARE LAB</span>
                    <h3 style="font-size: 1.4rem; font-weight: 700;">Precision Card &amp; Wearable Architecture</h3>
                </div>
                <div style="display: flex; gap: 0.5rem;">
                    <button class="artifact-toggle-btn active" data-artifact="card">Sovereign Titanium Card</button>
                    <button class="artifact-toggle-btn" data-artifact="ring">Apex NFC Ring</button>
                </div>
            </div>

            <div style="position: relative; width: 100%; height: 420px; border-radius: var(--radius-md); overflow: hidden; background: #FAF2EB;" id="canvasWrapper">
                <canvas id="webglCanvas" style="width: 100%; height: 100%; display: block;"></canvas>
                
                <div style="position: absolute; bottom: 15px; left: 15px; background: rgba(255,255,255,0.85); backdrop-filter: blur(10px); padding: 0.5rem 1rem; border-radius: var(--radius-sm); font-size: 0.78rem; font-family: var(--font-mono); color: var(--text-main); border: 1px solid var(--border-light);">
                    <span>Interactive 3D GPU Engine • Rotate with Mouse / Touch</span>
                </div>

                <div id="cardFinishSelector" style="position: absolute; bottom: 15px; right: 15px; display: flex; gap: 0.4rem;">
                    <button class="card-finish-btn active" data-card-finish="stealth" style="padding: 0.35rem 0.75rem; font-size: 0.75rem; background:#1A130E; color:#fff; border-radius:var(--radius-full);">Stealth Metal</button>
                    <button class="card-finish-btn" data-card-finish="titanium" style="padding: 0.35rem 0.75rem; font-size: 0.75rem; background:#E5E5E5; color:#1A130E; border-radius:var(--radius-full);">Pale Titanium</button>
                    <button class="card-finish-btn" data-card-finish="gold" style="padding: 0.35rem 0.75rem; font-size: 0.75rem; background:#D4AF37; color:#1A130E; border-radius:var(--radius-full);">24K Gold</button>
                    <button class="card-finish-btn" data-card-finish="ceramic" style="padding: 0.35rem 0.75rem; font-size: 0.75rem; background:#F8F9FA; color:#1A130E; border-radius:var(--radius-full);">Ceramic</button>
                </div>

                <div id="ringFinishSelector" class="hidden" style="position: absolute; bottom: 15px; right: 15px; display: flex; gap: 0.4rem;">
                    <button class="ring-finish-btn active" data-finish="silver" style="padding: 0.35rem 0.75rem; font-size: 0.75rem; background:#E5E5E5; color:#1A130E; border-radius:var(--radius-full);">Silver</button>
                    <button class="ring-finish-btn" data-finish="black" style="padding: 0.35rem 0.75rem; font-size: 0.75rem; background:#1A130E; color:#fff; border-radius:var(--radius-full);">Black</button>
                    <button class="ring-finish-btn" data-finish="gold" style="padding: 0.35rem 0.75rem; font-size: 0.75rem; background:#D4AF37; color:#1A130E; border-radius:var(--radius-full);">Gold</button>
                </div>
            </div>
        </div>
    </div>
